      ...
      <Slider {...settings}>
        {coins.map((coin) => {
          ...
          return (
            <div
              key={coin.symbol}
              className="flex flex-col items-center justify-center h-40s text-center"
            >
              <img
                src={coin.img}
                alt={coin.symbol}
                className="w-20 h-20 md:w-24 md:h-24 object-contain drop-shadow-md transition-transform hover:scale-105 duration-300"
              />
